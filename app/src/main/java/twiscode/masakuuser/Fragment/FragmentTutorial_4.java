 ...
 */
public class FragmentTutorial_4 extends Fragment {
    private static final String ARG_COLOR = "color";
    ProgressBar progressBar;
    private String mColor;

    public static FragmentTutorial_4 newInstance(String param1) {
        FragmentTutorial_4 fragment = new FragmentTutorial_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.tutorial_slider_fragment_4, container, false);
