...
public class FragmentCustomerService extends Fragment {
	...
	public static FragmentCustomerService newInstance(int page) {
		Bundle args = new Bundle();
		args.putInt(ARG_PAGE, page);
		FragmentCustomerService fragment = new FragmentCustomerService();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.activity_cs, container, false);
