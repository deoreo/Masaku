...
public class ModelAllMenus {
    ...
    public ModelAllMenus(String id, String nama, String price, String foto, String time, JSONArray feedback){
        this.id = id;
        this.nama = nama;
        this.price = price;
        this.foto = foto;
    ...
    public ModelAllMenus(String id, String nama, String price, String foto, String time, String deskripsi, JSONArray feedback){
        this.id = id;
        this.nama = nama;
        this.price = price;
        this.foto = foto;
